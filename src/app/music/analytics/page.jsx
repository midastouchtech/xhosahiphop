          ...
          <div className='under-hero container'>
            ...
            <div className='section'>
              <div className='mb-5 fs-6'>
                <h3>
                  Hi <span className='text-primary'>Admin</span>, Welcome to the
                  XhosaHipHop
                </h3>
                <p>
                  Select your music to listen & download free and premium music.
                </p>
              </div>
                  ...
                  <div className='card bg-primary text-white'>
                    <div className='card-body fs-6'>
                      <div className='d-flex align-items-center justify-content-between mb-2'>
                        <h4 className='text-white mb-0'>Total Earnings</h4>
                        <button
                          type='button'
                      ...
                      <p>
                        Voluptatem ut, facilis ipsum, nostrum quia officia dolor
                        mollitia temporibus hic aspernatur laborum.
                      </p>
