...
var Albums = function (_a) {
    ...
    return (<>
            ...
            <div className='under-hero container'>
                <Section title='Trending <span class="text-primary">Albums</span>' data={albums} card='album' slideView={5} navigation autoplay/>
                ...
                <div className='section'>
                    ...
                    <div className='list list--lg'>
                        <div className='row'>
                            {albums.map(function (item, index) { return (<div key={index} className='col-xl-6'>
