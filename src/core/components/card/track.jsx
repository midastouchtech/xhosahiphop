...
var TrackCard = function (_a) {
    var data = _a.data, dropdown = _a.dropdown, favorite = _a.favorite, queue = _a.queue, playlist = _a.playlist, play = _a.play, link = _a.link;
    ...
    <div className='cover cover--round scale-animation'>
            {/* Cover head */}
            {(dropdown || data.premium || data.favorite) && (<div className='cover__head'>
                    {(data.premium || data.favorite) && (<ul className='cover__label d-flex'>
                            {data.favorite && (<li>
                    ...
                    {dropdown && (<TrackDropdown className={replaceClassName('cover__options dropstart d-inline-flex ms-auto')} play={play} favorite={favorite} playlist={playlist} queue={queue} data={data} href={data.href} iconVertical/>)}
                </div>)}
            ...
            <div className='cover__foot'>
                {data.href ? (<Link href={data.href} className='cover__title text-truncate'>
                        {data.title ? data.title : data.name}
                    </Link>) : (<span className='cover__title text-truncate'>
                        {data.title ? data.title : data.name}
                    </span>)}
                {data.artists && (<div className='cover__subtitle text-truncate'>
