    ...
    <div className='cover cover--round scale-animation'>
            ...
            <div className='cover__foot mt-3 px-2'>
                <div className='cover__subtitle d-flex mb-2'>
                    ...
                    <span className={replaceClassName('ms-1 fw-semibold')} dangerouslySetInnerHTML={{ __html: removeHtml(data.address) }}></span>
                </div>
                <div className='mb-3'>
                ...
                <div className='d-flex align-items-center justify-content-between'>
                    ...
                    <Link className='btn btn-sm btn-light-primary' href={'/music/event/' + data.id}>
                        Join Event
                    </Link>
                </div>
            </div>
