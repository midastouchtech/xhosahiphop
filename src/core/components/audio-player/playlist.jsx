...
var Playlist = function () {
    ...
    var _a = usePlayer(), clearPlaylist = _a.clearPlaylist, songs = _a.songs;
    var isClient = useIsClient();
    // Handle link `onClick` event
    var handleClick = useEventCallback(clearPlaylist);
    return (
    // Playlist [[ Find at scss/framework/playlist.scss ]]
    isClient && (<div className={replaceClassName('playlist dropstart me-3')}>
                ...
                <div className='dropdown-menu playlist__dropdown'>
                    ...
                    <div className='playlist__body'>
                        {songs.length ? (<Scrollbar className='flex-1'>
                                <div className='list'>
                                    {songs.map(function (song, index) { return (<TrackList key={index} data={song} play remove/>); })}
                                </div>
                            </Scrollbar>) : (<div className='col-sm-8 col-10 mx-auto mt-5 text-center'>
