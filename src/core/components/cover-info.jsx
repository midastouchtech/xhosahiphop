      ...
      <div className='row'>
        ...
        <div className='col-md-8 mt-5 mt-md-0'>
          <div className='d-flex align-items-center flex-wrap'>
            <span
              className={replaceClassName('text-dark fs-4 fw-semibold pe-2')}
            >
          ...
          {!data.claimed && data.createdBy && (
            <small className='text-secondary'>
              This profile was automatically created by:{' '}
              {data.createdBy.stageName || data.createdBy.username} on{' '}
              {data.joined}. To claim it vist the following{' '}
              <Link href='/soon'>link</Link>
            </small>
          )}
          ...
          <ul className='info-list mt-5'>
              ...
              <div className='d-flex align-items-center'>
                {data.songs ? (
                  ...
                  <>
                    ...
                    <span
                      className={replaceClassName('ps-2 fw-semibold text-dark')}
                    >
                      {data.played}
                    </span>
                  </>
            ...
            <li>
              ...
              >
                <FavoriteIcon
                  className={classNames(data.favorite && 'text-danger')}
                />
          ...
          {data.lyrics && (
            <div className='mt-5'>
              <span className='d-block text-dark fs-6 fw-semibold mb-3'>
                Lyrics
              </span>
              <div dangerouslySetInnerHTML={{ __html: nl2br(data.lyrics) }} />
            </div>
          )}
        </div>
      </div>
