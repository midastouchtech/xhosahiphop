...
//
// Modules
import { RiHome4Line, RiDiscLine, RiMusic2Line, RiAlbumLine, RiMicLine, RiRadio2Line, RiPieChartLine, RiHeartLine, RiHistoryLine, RiCalendarEventLine, RiAddCircleLine, RiErrorWarningLine, RiUser3Line, RiSettingsLine, RiMoneyDollarCircleLine, RiGooglePlayFill, RiAppStoreFill, RiFacebookCircleLine, RiInstagramLine, RiPinterestLine, RiYoutubeLine, RiTwitterXLine, } from '@remixicon/react';
//
...
export var THEME_MODE = 'light';
//
// Components theme
export var HEADER_THEME = 'blue';
export var SIDEBAR_THEME = 'blue';
export var PLAYER_THEME = 'blue';
//
// Global HTML classes
