...
var AudioPlayer = React.forwardRef(function (props, ref) {
  var _a = useTheme(),
    replaceClassName = _a.replaceClassName,
    playerSkin = _a.playerSkin;
  var _b = usePlayer(),
        ...
        <div className='player-container'>
          ...
          <div className='cover d-flex align-items-center'>
            ...
            >
              ...
              >
                <p>test</p>
                {activeSong.title ? activeSong.title : activeSong.name} is was
              </Component>
              {activeSong.artists && (
                <p className='cover__subtitle text-truncate'>
                  {activeSong.artists.map(function (artist, index) {
                    return (
