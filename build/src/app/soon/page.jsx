...
export default function FourOFourPage() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, (<div className='d-flex align-items-center justify-content-center min-vh-100'>
      <div className='container text-center fs-5'>
        <div className='row'>
          <div className='col-xl-7 col-lg-9 col-lg-10 mx-auto'>
            ...
            <Link href='/' className='btn btn-lg btn-primary rounded-pill mt-5 text-light' style={{ minWidth: 200 }}>
              Go To Homepage
            </Link>
          </div>
        </div>
