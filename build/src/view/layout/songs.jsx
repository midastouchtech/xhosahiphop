...
var Songs = function (_a) {
    var albums = _a.albums, songs = _a.songs;
    ...
    return (<>
            ...
            <div className='under-hero container'>
                ...
                <div className='section'>
                    ...
                    <div className='list'>
                        <div className='row'>
                            {songs.map(function (item, index) { return (<div key={index} className='col-xl-6'>
                ...
                <Section title='Free <span class="text-primary">Albums</span>' data={albums} card='album' slideView={5} navigation autoplay/>
            </div>
        </>);
};
