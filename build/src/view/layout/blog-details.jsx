...
import { RiArrowLeftLine, RiArrowLeftSLine, RiArrowRightLine, RiArrowRightSLine, RiFacebookCircleLine, RiInstagramLine, RiTwitterXFill } from '@remixicon/react';
// Contexts
import { useTheme } from '@/core/contexts/theme';
var BlogDetails = function () {
    var _a = useTheme(), rtl = _a.rtl, replaceClassName = _a.replaceClassName;
    var ArrowComponent = rtl ? RiArrowRightSLine : RiArrowLeftSLine;
    var PrevArrowComponent = rtl ? RiArrowRightLine : RiArrowLeftLine;
    var NextArrowComponent = rtl ? RiArrowLeftLine : RiArrowRightLine;
    return (
            ...
            <div className='container'>
                <div className='col-xl-8 col-lg-10 mx-auto'>
                        ...
                        <div className='d-sm-flex align-items-center justify-content-between'>
                            <div className='avatar avatar--lg mb-4 mb-sm-0'>
                                <div className='avatar__image'>
                                    <Image src='/images/users/thumb.jpg' width={128} height={128} alt='user'/>
                                </div>
                    ...
                    <div className='blog-hero'>
                        <Image src='/images/background/horizontal/3.jpg' className='img-fluid w-100' width={540} height={320} alt='Blog cover'/>
                    </div>
                    ...
                    <div className='d-flex align-items-center justify-content-center mt-5 fs-6'>
                        <Link href='#' className={replaceClassName('d-inline-flex align-items-center me-4')}>
